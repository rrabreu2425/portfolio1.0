...
import { IAuthService, type ILogin, type IRegister, type ILogout } from '@/modules/auth/business/services/auth.service';
...
import { RegisterCapability } from '@/modules/auth/capabilities/register.capability';
...
authContainer.bind<IRegister>(AUTH_SYMBOLS.Register).to(RegisterCapability);
